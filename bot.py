...
LESSON_PREVIEW = {
    ...
    2: ("🖥", "Покажем, как зайти в личный кабинет: установить браузер, найти письмо, создать пароль и войти."),
    3: ("🎥", "Все уроки проходят в Zoom. Научимся устанавливать его, входить и подключаться к занятию."),
    4: ("🧑‍🏫", "Куратор — твой помощник в школе. Расскажем, кто это и как быть с ним на связи."),
    5: ("🎉", "Как проходят занятия и где смотреть расписание. Готовимся к первым урокам."),
    6: ("🧪", "Как устроены тесты и из чего складывается оценка."),
    7: ("✏️", "Как проверять себя и закреплять материал между уроками."),
    8: ("📤", "Как выполнять и загружать письменные домашние работы."),
    ...
    14: ("⚠️", "Главные правила аттестации, чтобы сдать всё без сюрпризов."),
