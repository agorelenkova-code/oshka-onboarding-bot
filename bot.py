...
async def on_start(message: Message) -> None:
    ...
    await message.answer(
        ...
        "адаптации в школе</b>, чтобы с первых дней ты чувствовал(а) себя уверенно "
        "и ничего важного не упустил(а).\n\n"
        "Вместе мы шаг за шагом разберёмся, как войти на платформу, настроить Zoom, "
        "проходить уроки и сдавать аттестации. А ещё я сориентирую тебя по "
        "<b>важным этапам зачисления</b>, чтобы ты ничего не пропустил(а) по срокам.\n\n"
        ...
        "• По дням буду напоминать, какой урок пройти, чтобы ты ничего не пропустил(а).\n\n"
        "Поехали 👇",
        reply_markup=kb,
    )
